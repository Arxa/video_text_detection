...
//    {
//        FileProcessor player = new FileProcessor();
//        FileProcessor.setFilename(simpleMovingTextVideo);
//
//        Assert.assertTrue("Video File is not valid",
//                player.validateVideoFileName(FileProcessor.getFilename()) == 1);
//        Assert.assertTrue("Failed to update directories",player.createDirectories());
//
